...
public class add_customer extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String p_no=passport.getText();
            String n_id=national.getText();
            ...
            String dob=db.format(dateofbirth.getDate());
            
            Connection con;
            PreparedStatement pre;
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/airline_resevation", "root", "dineshdk");
            Class.forName("com.mysql.jdbc.Driver");
            pre=con.prepareStatement("insert into customer(customer_id,first_name,last_name,passport_no,national_id,address,contact,gender,dob) values (?,?,?,?,?,?,?,?,?)");
            
            pre.setString(1,c_id);
            pre.setString(2,f_name);
            pre.setString(3,l_name);
            pre.setString(4,p_no);
            pre.setString(5,n_id);
